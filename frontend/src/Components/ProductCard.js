...
const ProductCard = ({ product, variant, variantIndex}) => {
  return (
    <Link to={`product/${product?._id}/${variant?._id}`}>
      <div className="w-36 min-[375px]:w-40 md:w-36 lg:w-40 xl:w-44 shadow-custom bg-customCard duration-300 ease-in-out hover:scale-105 rounded-lg cursor-pointer">
        <div className="relative h-36 min-[375px]:h-40 md:h-36 lg:h-40 xl:h-44 bg-zinc-800 rounded-t-lg">
          <img
            key={variantIndex}
