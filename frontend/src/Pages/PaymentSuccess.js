    ...
    <div className="w-full flex justify-center items-center p-4 text-white">
      <div className="flex flex-col items-center p-4 gap-1 shadow-lg shadow-stone-300 rounded-lg bg-stone-700">
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <Link className="w-full max-w-36 p-1 text-center rounded-full bg-green-500 shadow-sm shadow-white active:shadow-none active:translate-y-0.5 transition-all">
            Go to Orders
          </Link>
        </div>
      </div>
